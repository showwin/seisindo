...
#06.設置者のアドレス(カンマ区切り)
$conf{'mailto'} = 'ms@seisindo.com';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = 'http://www.seisindo.com/sousinsp.htm';

#08.設置者に届くメールの件名
$conf{'subject'} = '問診票の返送 ＳＰ';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '問診票を受け付けました';
...
順番に診断結果をお送りしておりますので、今しばらくお待ちください。
２４時間経ってもこちらからの返信が来なければ、再度ご連絡下さい。
正常に送信されていない場合があります。

何かわからないことや不安なことが有りましたら、いつでもお気軽にご相談下さい。

...
#06.設置者のアドレス(カンマ区切り)
$conf{'mailto'} = 'satomi@tcm-jp.com';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = 'http://www.seisindo.com/kanryou2.htm';

#08.設置者に届くメールの件名
$conf{'subject'} = '購入代行依頼書';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '承りました';
...
ご依頼頂きました代行購入を承りました。
代金の支払い方法及び発送先等の詳細は、漢方のセイシンドーから聞きまして、間違いなく送らせて頂きます。

なお、この代行サービスにおきましては、一切の費用は発生しませんので、どうぞご安心ください。

ご質問等は、直接漢方のセイシンドーの方へお願いいたします。

*******送信内容のご確認*******

川上　砂都美　様
私は、遠方で直接に漢方のセイシンドーへ出向いて商品を受け取ることができません。つきましては、既に漢方のセイシンドーで相談し決定しました商品を、私の代わりに購入して私の元にお送り願います。
代金の支払い方法及び発送先は、漢方のセイシンドーへ連絡してありますので、そちらでお聞きください。
以下に私の名前と住所を記載しておきますので、漢方のセイシンドーの店頭にて言って頂ければ詳細がわかります。

<resbody>

以上　私は　川上砂都美　様に購入の代行を依頼します。

******************************

★－－★－－★－－★－－★－－★

525-0066 滋賀県草津市矢橋町５２－５０
　　　　川上　砂都美
TEL & FAX     077-563-4141 
　　　satomi@tcm-jp.com
